...
<template>
  ...
  <div class="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 relative gap-[15px] px-5 py-[30px]">
    ...
    <p class="self-stretch flex-grow-0 flex-shrink-0 w-[354.67px] text-base text-left text-gray-500">
      {{ adresse }}
    </p>
    <svg
      width="355"
    ...
    <div class="flex justify-center items-center self-stretch flex-grow-0 flex-shrink-0 gap-1.5">
      ...
      <div class="flex justify-center items-center flex-grow relative gap-2">
        <svg
          ...
          preserveAspectRatio="xMidYMid meet"
        >
          <g clip-path="url(#clip0_32966_519)">
            <path
      ...
      <div class="flex justify-end items-center flex-grow relative gap-2">
        ...
        >
          <g clip-path="url(#clip0_32966_527)">
            <path
